...
while True:
    ...
    output_directory = input("Enter the (existing) directory to save the outputs: ")
    ...
    with io.open(input_file, encoding="utf-8") as file:
        ...
        try:
            ...
            proceed = bool(input("Leave blank to end program, type anything to continue: "))
            if not(proceed): break

        # Saves humidity values into a separate file
        with io.open("{}/recording_output/humidity.txt".format(output_directory), "w", encoding="utf-8") as humidity_file:
            for line in lines:
                try:
        ...
        with io.open("{}/recording_output/temperature.txt".format(output_directory), "w", encoding="utf-8") as temp_file:
            for line in lines:
                try:
        ...
        with io.open("{}/recording_output/pressure.txt".format(output_directory), "w", encoding="utf-8") as pressure_file:
            for line in lines:
                try:
        ...
        for axis in axes:
            with io.open("{}/recording_output/{}_accel.txt".format(output_directory, axis), "w", encoding="utf-8") as accel_file:
                for line in lines:
                    try:
            ...
            with io.open("{}/recording_output/{}_magnet.txt".format(output_directory, axis), "w", encoding="utf-8") as magnet_file:
                for line in lines:
                    try:
            ...
            with io.open("{}/recording_output/{}_gyro.txt".format(output_directory, axis), "w", encoding="utf-8") as gyro_file:
                for line in lines:
                    try:
